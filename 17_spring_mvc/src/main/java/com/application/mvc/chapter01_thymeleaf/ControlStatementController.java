...
public class ControlStatementController {
	...
	public String ex01(Model model) {
		...
		return "chapter01_thymeleaf/controlStatement/controlEx01";
	...
	public String ex02(Model model) {
		...
		String menu = "권한관리"; // 권한관리 , 일정관리 , 위험관리
		model.addAttribute("menu" , menu); 
		
		return "chapter01_thymeleaf/controlStatement/controlEx02";
	...
	public String ex03(Model model) {
		...
		return "chapter01_thymeleaf/controlStatement/controlEx03";
	...
	public String ex04(Model model) {
		...
		return "chapter01_thymeleaf/controlStatement/controlEx04";
