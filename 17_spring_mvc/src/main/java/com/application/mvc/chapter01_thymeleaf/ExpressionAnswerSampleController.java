...
public class ExpressionAnswerSampleController {

	@Autowired
	private SupposeDAO supposeDAO;
	
	@GetMapping("/ex04_answerSample")
	public String ex04_answerSample(Model model) {
		...
		return "chapter01_thymeleaf/expression/expressionEx04_answerSample";
	...
	public String ex06_answerSample(Model model) {
		...
		return "chapter01_thymeleaf/expression/expressionEx06_answerSample";
	...
	public String ex07_answerSample(Model model) {
		...
		return "chapter01_thymeleaf/expression/expressionEx07_answerSample";
	...
	public String ex08_answerSample(Model model) {
		...
		return "chapter01_thymeleaf/expression/expressionEx08_answerSample";
		
	}
	
	
	@GetMapping("/ex09_answerSample")
	public String ex09_answerSample(HttpServletRequest request) {
		
		/*
		 
		  - expressionEx09_practice.html파일에 아래와같이 데이터를 출력하시오.
		  
		  - session 객체에 데이터를 저장하고 화면에 출력하시오.
		...
		return "chapter01_thymeleaf/expression/expressionEx09_answerSample";
		
	}

	
	@GetMapping("/ex10_answerSample")
	public String ex10_answerSample(Model model) {
		...
		return "chapter01_thymeleaf/expression/expressionEx10_answerSample";
